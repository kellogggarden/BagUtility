    ...
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> JobDetailAsync(int id, string site, string workCenter = null)
        {
            try {
                ...
                {
                    ViewBag.CreatedBy = "agent2@kellogggarden.com";
                }
                ...
                ViewBag.Materials = await _orderService.GetProductionItemMaterials(job.RunID, job.ID, site, job.ProductionScheduleID, job.ItemID, job.DueDate.ToString("MM/dd/yyyy"));
