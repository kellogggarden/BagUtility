...
namespace KGP.Services
{
    public interface IOrderService
    {
        ...
        public Task<List<ProductionMaterial>> GetProductionItemMaterials(int headerId, int lineId, string warehouse, string scheduleId, string itemId, string dueDate);
